...
module.exports = ( interfaceDef )->
	return  """\n
		...
		public Map #{Utils.getMethodName interfaceDef.interfaceUrl}( Map beanMap ){
			return V6SqlSessionUtil.getSqlSession().selectOne( "#{Utils.getCmdName( interfaceDef.interfaceUrl )}Domain.#{Utils.getMethodName interfaceDef.interfaceUrl}", beanMap );
		}
		\n
	"""